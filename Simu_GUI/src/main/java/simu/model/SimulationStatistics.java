...
/**
 * Data class for storing simulation statistics.
 * Contains metrics such as customers served, throughput, average wait time,
 * peak queue length, and current simulation time.
 * 
 * @author Group 8
 * @version 1.0
 */
